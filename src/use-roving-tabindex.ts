 ...
 * @param {string?} options.id An optional non-empty string ID
 * that is a globally unique ID for identifying the DOM element.
 * This is required if you need to support server-side rendering (SSR).
 * If you do not need to support SSR then you can ignore this option;
 * an id will be autogenerated. If you use this option then the ID
 * you pass must be the same for the lifetime of the containing component.
 * @param {number} options.rowIndex An optional integer value that must be
